(ns riker-app.rest.resource.user.logout-all-other-res
...
(declare do-logout-all-other-fn)

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; Handler
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defn handle-logout-all-other-post!
  [ctx
   db-spec
   base-url
   entity-uri-prefix
...
;; do login function
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defmulti-by-version do-logout-all-other-fn meta/v001)

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; Resources Definitions
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defresource logout-all-other-res
  [db-spec
   mt-subtype-prefix
   hdr-auth-token
   hdr-error-mask
  ...
  :post! (fn [ctx] (handle-logout-all-other-post! ctx
                                                  db-spec
                                                  base-url
                                                  entity-uri-prefix
                                                  (:uri (:request ctx))
